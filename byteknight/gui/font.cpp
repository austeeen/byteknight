...
namespace bt::gui
{
Font::Font(): __font(new sf::Font()), __max_cache_size(20), __default_char_size(32)
{}
Font::~Font()
{
    destroy(this->__font);
...
bool Font::load(const std::string& font_fp)
{
...
sptr<sf::Text> Font::asText(const std::string& linestr, const sf::Color& color, const unsigned int maxlinew)
{
...
void Font::__createText(const std::size_t hash, const std::string& linestr, const sf::Color& color,
